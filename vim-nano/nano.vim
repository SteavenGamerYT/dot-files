...
function! DrawLayout()
    ...
    resize 1
    if has('nvim')
        call termopen('python /home/omarhanykasban/Documents/GitHub/dot-files/vim-nano/topbar.py')
    else
    ...
    enew
    if has('nvim')
        call termopen('python /home/omarhanykasban/Documents/GitHub/dot-files/vim-nano/botbar.py')
        execute "$"
    else
